...
public class FloatBandedRaster extends WritableRaster {
    ...
    /**
     *  Constructs a FloatBandedRaster with the given sampleModel. The
    ...
    /**
     *  Constructs a FloatBandedRaster with the given sampleModel,
     ...
     * and references anything other than an array of transferType.
     * <pre>
     *       float[] bandData = (float[])raster.getDataElement(x, y, w, h, null);
     *       int numDataElements = raster.getNumDataElements();
     *       float[] pixel = new byte[numDataElements];
...
//      if (inRaster instanceof FloatBandedRaster) {
//      }
...
//                                    this);
    ...
    public String toString() {
        return new String ("FloatBandedRaster: width = "+width+" height = "
                           + height
