...
public class RGBBufferedImageTest {

	public static void main(String[] args) throws IOException {
		
		final PixelBufferedImage pbi = new PixelBufferedImage(ImageIO.read(new File("/Library/Desktop Pictures/Nature/Cirques.jpg")).getSubimage(600, 200, 500, 500), BufferedImage.TYPE_INT_RGB);
		
		final RGBBufferedImage ypbi = new RGBBufferedImage(pbi.width, pbi.height);
		
//		for (int y=0,o=pbi.offset, O=ypbi.offset, r = pbi.scan-pbi.width, R = ypbi.scan-ypbi.width;y<pbi.height;y++,o+=r, O+=R)
